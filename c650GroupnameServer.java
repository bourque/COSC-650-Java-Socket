...
class ServerDriver{
    ...
    private void sendFileToClient(String ipFile, int port, String ESWIPaddr ) throws UnknownHostException
    {
		...
		System.out.println(ESWIPaddr.getBytes().length);
		System.arraycopy(ESWIPaddr.getBytes(), 0, buf, 0, ESWIPaddr.getBytes().length);
		
		System.arraycopy(marker.getBytes(), 0, buf, ESWIPaddr.getBytes().length, marker.getBytes().length);
		
		System.arraycopy(numberofpacksstr.getBytes(), 0, buf, ESWIPaddr.getBytes().length + marker.getBytes().length , numberofpacksstr.getBytes().length);
		System.arraycopy(marker.getBytes(), 0, buf, ESWIPaddr.getBytes().length + marker.getBytes().length + numberofpacksstr.getBytes().length, marker.getBytes().length);
		System.arraycopy(strfilesize.getBytes(), 0, buf, ESWIPaddr.getBytes().length + marker.getBytes().length + numberofpacksstr.getBytes().length + marker.getBytes().length, strfilesize.getBytes().length);
		System.out.println(ESWIPaddr.getBytes().length + numberofpacksstr.getBytes().length + strfilesize.getBytes().length);
		
		System.out.println(buf.length);
		System.out.println(strfilesize.getBytes().length);
		System.out.println(numberofpacksstr.getBytes().length);
		System.out.println(ESWIPaddr.getBytes().length);
